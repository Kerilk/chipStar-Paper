...
The performance of GAMESS was measured by compiling and running the same HIP source code on a PVC through \chipstar (Release 1.2), an Nvidia A100 using CUDA 12.2.2 with ROCm 6.0.0, and AMD MI250 using ROCm 6.0.0. 
...
Total SCF time (s) & Nvidia A100 & AMD MI250 & Intel PVC (Level Zero) & Intel PVC (OpenCL) &  \\ \cline{1-5}
Average            & 1.66        & 26.34     & 3.63                   & 3.64               &  \\
Standard Deviation & 0.01        & 0.04      & 0.02                   & 0.06               &  \\ \cline{1-5}
\end{tabular}
