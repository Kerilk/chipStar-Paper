...
Interestingly, OpenCL was originally created to provide an open cross-vendor alternative to the proprietary CUDA GPGPU programming model. It didn't receive wide support from application developers since it was considered too low level and unproductive. However, thanks to its official support from multiple vendors and solid open source implementations available, OpenCL is the best portability layer for implementing other higher-level programming models such as CUDA/HIP. 
